...
docker tag backend-aiapp:latest quay.io/rh-ee-anahid/backend-aiapp:v5
docker push quay.io/rh-ee-anahid/backend-aiapp:v5
...
docker tag backend-wsserver:latest quay.io/rh-ee-anahid/backend-wsserver:v5
docker push quay.io/rh-ee-anahid/backend-wsserver:v5
cd ../../
...
docker tag frontend-aiapp:latest quay.io/rh-ee-anahid/frontend-aiapp:v4
docker push quay.io/rh-ee-anahid/frontend-aiapp:v4
cd ../../
